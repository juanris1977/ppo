...
public class ProductosView {
	...
	static void subirPrecioCategoria () {
		...
		categoria = sc.nextLine();
		service.subirPrecio(subida, 
							p->p.getCategoria().equalsIgnoreCase(categoria)	);
	}
	...
	static void eliminarProductos ( ) {
		System.out.println();
		System.out.println("De que categoria eliminamos todos los productos? ");
		service.eliminarProducto(sc.nextLine());		
	}
	
	static void mostrarProductos () {
		List<Producto> misproductos = service.mostrarProductos();		
